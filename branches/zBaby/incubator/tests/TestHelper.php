 ...
 * @version    $Id: TestHelper.php 13410 2008-12-21 10:30:39Z alexander $
 */
 ...
 * distribution.
 */
$zfStandardIncubatorRoot     = realpath(dirname(__FILE__) . '/../');
 ...
 */
if (is_readable($zfStandardIncubatorTests . DIRECTORY_SEPARATOR . 'TestConfiguration.php')) {
    require_once $zfStandardIncubatorTests . DIRECTORY_SEPARATOR . 'TestConfiguration.php';
} else {
    require_once $zfStandardIncubatorTests . DIRECTORY_SEPARATOR . 'TestConfiguration.php.dist';
}
